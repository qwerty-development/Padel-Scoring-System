  ...
  "group flex items-center justify-center rounded-full web:ring-offset-background web:transition-all web:duration-200 web:ease-in-out web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2 web:shadow-sm",
  {
    variants: {
      variant: {
        ...
        link: "web:underline-offset-4 web:hover:underline web:focus:underline web:hover:scale-[1.02] active:scale-[0.98] web:transition-transform web:duration-150",
      },
      size: {
        default:
          "h-12 px-6 py-3 native:h-14 native:px-7 native:py-4 min-w-[100px]",
  ...
  return (
    ...
    >
      <Pressable
        className={cn(
          props.disabled &&
            "opacity-50 web:pointer-events-none web:cursor-not-allowed web:hover:scale-100 web:hover:shadow-none",
