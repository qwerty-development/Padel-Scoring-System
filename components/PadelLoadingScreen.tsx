      ...
      >
        ...
        <View className="absolute w-full h-full rounded-full">
          ...
          <View className="absolute w-full h-1/2 rounded-t-full overflow-hidden">
            <View className="absolute h-full w-0.5 bg-primary-foreground left-1/4" style={{ transform: [{ rotate: '20deg' }] }} />
            <View className="absolute h-full w-0.5 bg-primary-foreground left-1/2" style={{ transform: [{ rotate: '20deg' }] }} />
            <View className="absolute h-full w-0.5 bg-primary-foreground left-3/4" style={{ transform: [{ rotate: '20deg' }] }} />
          </View>
